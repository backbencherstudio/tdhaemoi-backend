                  ...
                  questions: [
                    {
                      id: 1,
                      question:
                        "Möchten Sie ein Modell aus einer bestimmten Preisklasse?",
                      options: [
                        {
                          id: 1,
                  ...
                  questions: [
                    {
                      id: 1,
                      question:
                        "Wie bevorzugen Sie Ihre Allround - Laufschuhe zu tragen?",
                      options: [
                        {
                          id: 1,
                          option:
                    ...
                    },
                    {
                      id: 3,
                      question:
                        "Hatten Sie schon einmal Probleme oder Schmerzen beim Laufen?",
                      options: [
                        {
                          id: 1,
                          option: "Nein",
                    ...
                    },
                    {
                      id: 4,
                      question:
                        "Welche Rolle spielt Dämpfung im Verhältnis zu Stabilität?",
                      options: [
                        {
                          id: 1,
                          option:
                  ...
                  questions: [
                    {
                      id: 1,
                      question:
                        "Wie bevorzugen Sie Ihre Trailrunning - Schuhe zu tragen?",
                      options: [
                        {
                          id: 1,
                          option:
                    ...
                    },
                    {
                      id: 2,
                      question:
                        "Soll dein Schuh wasserdicht sein (Gore-Tex-Membran)?",
                      options: [
                        {
                          id: 1,
                          option:
                    ...
                    },
                    {
                      id: 3,
                      question:
                        "Wo wirst du deine Trailrunning-Schuhe hauptsächlich nutzen?",
                      options: [
                        {
                          id: 1,
                  ...
                  questions: [
                    {
                      id: 1,
                      question:
                        "Wie bevorzugen Sie Ihre Dauer - Laufschuhe zu tragen?",
                      options: [
                        {
                          id: 1,
                          option:
                    ...
                    },
                    {
                      id: 2,
                      question:
                        "Auf welchem Untergrund wirst du hauptsächlich laufen?",
                      options: [
                        {
                          id: 1,
                          option:
                        ...
                        },
                        {
                          id: 3,
                          option:
                            "Gemischt – Für eine Kombination beider Oberflächen",
                        },
                      ],
                    },
                    {
                  ...
                  questions: [
                    {
                      id: 1,
                      question:
                        "Wie bevorzugen Sie Ihre Wettkampf - Schuhe zu tragen?",
                      options: [
                        {
                          id: 1,
                          option:
                    ...
                    },
                    {
                      id: 3,
                      question:
                        "Für welche Distanz suchst du Wettkampf-Schuhe?",
                      options: [
                        {
                          id: 1,
                    ...
                    },
                    {
                      ...
                      options: [
                        ...
                        },
                        {
                          id: 2,
                          option:
                            "≤ 5 mm – Direkter Abdruck, erfordert trainierte Technik.",
                        },
                      ],
                    },
                  ],
                  ...
                  questions: [
                    {
                      id: 1,
                      question:
                        "Wie bevorzugen Sie Ihre Intervall - Laufschuhe zu tragen?",
                      options: [
                        {
                          id: 1,
                          option:
                    ...
                    },
                    {
                      id: 2,
                      question:
                        "Auf welchem Untergrund läufst du deine Intervalltrainings?",
                      options: [
                        {
                          id: 1,
                            ...
                            questions: [
                              {
                                id: 1,
                                question:
                                  "Welche Distanz läufst du bei deinen Intervalltrainings?",
                                options: [
                                  {
                                    id: 1,
                  ...
                  questions: [
                    {
                      id: 1,
                      question:
                        "Wie bevorzugen Sie Ihre Walking - Laufschuhe zu tragen?",
                      options: [
                        {
                          id: 1,
                          option:
                    ...
                    },
                    {
                      id: 2,
                      question:
                        "Auf welchem Untergrund wirst du hauptsächlich unterwegs sein?",
                      options: [
                        {
                          id: 1,
                          option:
                    ...
                    },
                    {
                      id: 3,
                      question:
                        "Bevorzugen Sie eine höhere Sohle oder eine normale bis mittlere Sohlenhöhe?",
                      options: [
                        {
                          id: 1,
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            id: 5,
            question:
              "Möchtest du mit einer individuell angepassten Winsole deine Performance auf das nächste Level heben?",
            options: [
              {
                id: 1,
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            id: 4,
            question:
              "Bewegst du dich mehr seitlich oder sprintest oft vor und zurück?",
            options: [
              {
                id: 1,
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            id: 3,
            question:
              "Brauchst du mehr Knöchelschutz oder mehr Bewegungsfreiheit?",
            options: [
              {
                id: 1,
        ...
        questions: [
          {
            ...
            options: [
              ...
              },
              {
                id: 2,
                option:
                  "Eher enger, für reduzierten Komfort und maximaler Performance",
              },
              {
                id: 3,
                option:
          ...
          },
          {
            id: 4,
            question:
              "Was ist dir bei der Sohle deines Kletterschuhs am wichtigsten?",
            options: [
              {
                id: 1,
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            id: 3,
            question:
              "Was ist Ihnen wichtiger – Geschwindigkeit oder Stabilität?",
            options: [
              {
                id: 1,
                option:
          ...
          },
          {
            id: 4,
            question:
              "Welche Preisklasse bevorzugst du für deine Fußballschuhe?",
            options: [
              {
                id: 1,
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            id: 2,
            question:
              "Spikes oder Spikeless – Welcher Sohlen-Typ benötigst du?",
            options: [
              {
                id: 1,
                option: "Spikeless",
          ...
          },
          {
            id: 3,
            question:
              "Wie wichtig sind Wasserdichtigkeit und Atmungsaktivität bei deinen Golfschuhen?",
            options: [
              {
                id: 1,
    ...
    questions: [
      {
        id: 1,
        question:
          "Auf welchem Untergrund werden Sie den Schuh hauptsächlich nutzen?",
        options: [
          {
            id: 1,
...
export const InsolesQuestionnaData = [
  {
    id: 1,
    title: "Einsatzbereich",
    questions: [
      {
        question: "Welches Aktivitätslevel Trifft Am Besten Auf Sie Zu?",
        options: [
          {
            id: 1,
            option:
          ...
          {
            id: 2,
            option: "Mäßig aktiv (leichte körperliche Aktivität oder Gehen)",
            ownText: "",
          },
          {
            id: 3,
            option: "Wenig aktiv (hauptsächlich sitzende Tätigkeit)",
            ownText: "",
          },
          {
            id: 4,
            option: "Sehr wenig aktiv",
            ownText: "",
          },
        ],
      },
  ...
  },
  {
    ...
    questions: [
      {
        question:
          "Haben Sie Gesundheitliche Probleme Wie Diabetes Oder Andere Erkrankungen, Die Ihre Fußgesundheit Beeinträchtigen Könnten?",
        options: [
          {
            id: 1,
            option: "Ja, bitte eingeben",
            ownText: "",
          },
          {
            id: 2,
  ...
  },
  {
    ...
    questions: [
      {
        question: "Wie Viel Wiegen Sie Ca.?",
        options: [
          {
            id: 1,
            option: "Unter 50kg",
    ...
    questions: [
      {
        ...
        options: [
          {
            id: 1,
            question: "Wann haben die Schmerzen begonnen?",
            options: [
              {
                id: 1,
                option: "Vor weniger als einer Woche",
                ownText: "",
              },
              {
                id: 2,
                option: "Seit mehreren Wochen ",
                ownText: "",
              },
              {
                id: 3,
                option: "Seit mehreren Monaten",
                ownText: "",
              },
              {
                id: 4,
                option: "Seit über einem Jahr",
                ownText: "",
              },
              {
                id: 5,
                option: "Ich kann es nicht genau sagen",
                ownText: "",
              },
              {
                id: 6,
                option: "Die Schmerzen treten immer wieder auf",
                ownText: "",
              },
              {
                id: 7,
                option: "seit längerer Zeit",
                ownText: "",
              },
              {
                id: 8,
                option:
                  "Erst seit einer bestimmten Belastung (z. B. Sport, langes Gehen)",
                ownText: "",
              },
              {
                id: 9,
                option: "Nach einer Verletzung / Operation",
                ownText: "",
              },
              {
                id: 10,
                option: "Seit ich neue Schuhe trage",
                ownText: "",
              },
              {
                id: 11,
                option: "Seit meiner Schwangerschaft / Geburt",
                ownText: "",
              },
              {
                id: 12,
                option:
                  "Seit einer beruflichen Veränderung (z. B. mehr Stehen)",
                ownText: "",
              },
            ],
          },
          {
            id: 2,
            question: "Wie beeinflussen die Schmerzen deinen Alltag?",
            options: [
              {
                id: 1,
                option: "Ich kann keine längeren Strecken mehr gehen",
                ownText: "",
              },
              {
                id: 2,
                option: "Ich muss häufiger Pausen machen",
                ownText: "",
              },
              {
                id: 3,
                option: "Ich kann meinen Sport nicht mehr ausüben",
                ownText: "",
              },
              {
                id: 4,
                option: "Ich stehe ungern längere Zeit",
                ownText: "",
              },
              {
                id: 5,
                option: "Ich vermeide bestimmte Bewegungen",
                ownText: "",
              },
              {
                id: 6,
                option: "Ich habe Angst vor Verschlechterung",
                ownText: "",
              },
              {
                id: 7,
                option: "Ich schlafe schlechter",
                ownText: "",
              },
              {
                id: 8,
                option: "Es beeinträchtigt meine Arbeit",
                ownText: "",
              },
              {
                id: 9,
                option: "Es belastet mich psychisch",
                ownText: "",
              },
              {
                id: 10,
              ...
              {
                id: 11,
                option: "ich komme noch gut damit zurecht",
                ownText: "",
              },
              {
                id: 12,
                option: "Es ist situativ unangenehm, aber erträglich",
                ownText: "",
              },
              {
                id: 13,
              ...
              {
                id: 14,
                option: "ich bin im Alltag deutlich eingeschränkt",
                ownText: "",
              },
            ],
          },
          {
            id: 3,
            question: "Wie fühlen sich die Schmerzen an?",
            options: [
              {
                id: 1,
                option: "Stechend",
              ...
              {
                id: 8,
                option: "Wechselt / schwer zu beschreiben",
                ownText: "",
              },
            ],
          },
          {
            id: 4,
            question: "Wann verstärken sich die Schmerzen?",
            options: [
              {
                id: 1,
                option: "Beim Barfußgehen",
                ownText: "",
              },
              {
                id: 2,
                option: "Beim Tragen von Schuhen mit harter Sohle",
                ownText: "",
              },
              {
                id: 3,
                option: "Nach längerem Stehen",
                ownText: "",
              },
              {
                id: 4,
                option: "Beim Laufen / Joggen",
                ownText: "",
              },
              {
                id: 5,
                option: "Beim Gehen bergauf / bergab",
                ownText: "",
              },
              {
                id: 6,
                option: "Bei schneller Bewegung / Sprint",
                ownText: "",
              },
              {
                id: 7,
                option: "Bei bestimmten Bewegungen (z. B. Abrollen)",
                ownText: "",
              },
              {
                id: 8,
                option: "Nach dem Aufstehen",
                ownText: "",
              },
              {
                id: 9,
                option: "Nach Belastung",
                ownText: "",
              },
              {
                id: 10,
                option: "Ohne erkennbaren Auslöser",
                ownText: "",
              },
            ],
          },
...

  {
    ...
    questions: [
      {
        question: "Haben sie sonst noch relevante Schmerzen oder beschwerden?",
        options: [
          {
            id: 1,
            option: "Nein",
          ...
          {
            id: 2,
            option: "Ja, Rückenschmerzen",
            ownText: "",
          },
          {
            id: 3,
            option: "Ja, Hüftprobleme",
            ownText: "",
          },
          {
            id: 4,
          ...
          {
            id: 5,
            option: "Ja, Achilessehnenprobleme",
            ownText: "",
          },
          {
            id: 6,
            option: "Ja, Gelenkschmerzen",
            ownText: "",
          },
          {
            id: 7,
            option: "Andere, bitte angeben",
            ownText: "",
          },
        ],
      },
  ...
  },
  {
    ...
    questions: [
      {
        question: "Welche Erwartungen oder Ziele haben Sie mit Einlagen?",
        options: [
          {
            id: 1,
            option: "Besserer Komfort",
            ownText: "",
          },
          {
            id: 2,
            option: "Unterstützung bei Fußproblemen",
            ownText: "",
          },
          {
            id: 3,
            option: "Bessere Performance beim Sport",
            ownText: "",
          },
          {
            id: 4,
            option: "Vorbeugen von Fußschmerzen",
            ownText: "",
          },
          {
            id: 5,
            option: "Andere, bitte eingeben",
            ownText: "",
          },
        ],
      },
