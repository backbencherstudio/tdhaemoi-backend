...
const partnershipWelcomeEmail = (email, password) => {
    return `
      <!DOCTYPE html>
      <html>
      <head>
...
exports.partnershipWelcomeEmail = partnershipWelcomeEmail;
const newSuggestionEmail = (name, email, phone, firma, suggestion) => {
    return `
      <!DOCTYPE html>
      <html>
      <head>
...
exports.newImprovementEmail = newImprovementEmail;
const adminLoginNotificationEmail = (adminEmail, adminName, loginDate, loginTime, ipAddress) => {
    return `
  <!DOCTYPE html>
  <html lang="en">
  <head>
