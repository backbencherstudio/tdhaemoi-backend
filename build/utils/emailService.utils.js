...
exports.sendPdfToEmail = exports.sendAdminLoginNotification = exports.sendImprovementEmail = exports.sendNewSuggestionEmail = exports.sendPartnershipWelcomeEmail = exports.sendForgotPasswordOTP = exports.sendEmail = exports.generateOTP = void 0;
...
const sendPdfToEmail = async (email, pdf) => {
    // Read PDF content
    const pdfBuffer = fs_1.default.readFileSync(pdf.path);
  ...
  `;
    await (0, exports.sendEmail)(email, "Exercise directions", htmlContent);
};
exports.sendPdfToEmail = sendPdfToEmail;
