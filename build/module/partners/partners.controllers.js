...
exports.changePassword = exports.resetPassword = exports.forgotPasswordVerifyOtp = exports.forgotPasswordSendOtp = exports.changePasswordSendOtp = exports.deletePartner = exports.updatePartnerByAdmin = exports.getPartnerById = exports.getAllPartners = exports.updatePartnerProfile = exports.createPartnership = void 0;
...
const updatePartnerByAdmin = async (req, res) => {
    ...
    try {
        ...
        if (!user || user.role !== "PARTNER") {
            if (newImage) {
                const filepath = path_1.default.join(__dirname, "../../uploads", newImage.filename);
        ...
        if (password) {
            ...
            updatedPassword = await bcryptjs_1.default.hash(password, 10);
        }
        if (newImage && user.image) {
            const oldImagePath = path_1.default.join(__dirname, "../../uploads", user.image);
            if (fs_1.default.existsSync(oldImagePath))
                fs_1.default.unlinkSync(oldImagePath);
        }
        ...
        res.status(200).json({
            ...
            partner: {
                ...
                password,
                role: updated.role,
                image: updated.image ? (0, base_utl_1.getImageUrl)(`/uploads/${updated.image}`) : null,
            },
        });
    }
    catch (error) {
...
const deletePartner = async (req, res) => {
    try {
        ...
        if (partner.image) {
            const imagePath = path_1.default.join(__dirname, "../../uploads", partner.image);
            if (fs_1.default.existsSync(imagePath)) {
                fs_1.default.unlinkSync(imagePath);
            }
        }
...
exports.changePasswordSendOtp = changePasswordSendOtp;
...
//# sourceMappingURL=partners.controllers.js.map